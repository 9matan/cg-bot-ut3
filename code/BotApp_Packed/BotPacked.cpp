...
namespace ut3 {namespace bot {class CBotBase : public IBot{public:SOutputData FirstUpdate(SInputData initData) override;SOutputData Update(SInputData turnData) override;void SetDebugIsEnabled(bool const enableDebug) override { m_isDebugEnabled = enableDebug; }protected:virtual SVec2 FindTurn(game::SGameState const& gameState) = 0;protected:game::SGameState m_gameState;bool m_isDebugEnabled = false;};}}
namespace ut3 {namespace bot {class CMinimaxBot_v1 : public CBotBase{public:static SVec2 FindTurn(game::SGameState const& gameState, int const myPlayer, bool const debugEnabled = false);public:SOutputData FirstUpdate(SInputData initData) override;char const* GetBotName() const override { return "CMinimaxBot_v1"; }protected:SVec2 FindTurn(game::SGameState const& gameState) override;private:int m_myPlayer = -1;};}}
